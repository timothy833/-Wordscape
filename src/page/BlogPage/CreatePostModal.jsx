...
const NewPostModal = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      let uploadFinalImage = selectedFile
      ...
      if (tags.length > 0) {
        await axios.post(
          `${API_BASE_URL}/posts/${newPostId}/tags`,
          { tags },
          {
            headers: {
              Authorization: `Bearer ${token}`,
          ...
          <div className="modal-body">
            ...
            <div className="d-flex gap-2 justify-content-center align-items-center mb-2">
              ...
              <input
                ...
                value={externalImage}
                onBlur={handleExternalImageBlur}
            ...
            <div className="d-flex gap-2 flex-column flex-md-row">
              ...
              <div className="mb-2">
                <label htmlFor="文章tag標籤" className="form-label fw-medium">
                  文章標籤
                </label>
                <div className="d-flex gap-2">
                  ...
                  />
                  <button
                    className="btn btn-primary mb-2 btn-click"
                ...
                <div className="d-flex flex-wrap gap-2">
                  {tags.map((t) => (
                    <span
                      key={t}
                      className="badge bg-secondary fw-medium text-muted border"
                      style={{ fontSize: "14px" }}
                    >
                      {t}
                      <button
