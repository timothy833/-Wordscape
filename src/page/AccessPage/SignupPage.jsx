          ...
          <div className="login position-relative h-100">
            <div className="container-fluid h-100">
              <div className="row h-100 w-100 justify-content-center">
                {/* 左側區域 */}
                <div
                  className="d-none d-lg-block col-md-4 ps-5"
                  style={{ marginTop: "25vh" }}
                >
                  <div className="h1 fw-bold mb-3 text-dark">
                    歡迎加入我們！
                  </div>
                  <div className="fs-3 fw-normal mb-4 text-dark lh-sm">
                    一起踏上這段奇妙的旅程
                    <br />
                    發現更多有趣的事物！
                  </div>
                      ...
                      <form id="signupForm" noValidate onSubmit={signUpHandle}>
                        ...
                        <div className="form-floating mb-5">
                          <input
                            type="password"
                            className={`form-control border-0 ${
                              validated && formErrors.confirmPassword
                                ? "is-invalid"
                                : ""
                            }`}
                        ...
                        <div className="d-grid mb-5">
                          <button
                            type="submit"
                            className="btn btn-primary py-3 btn-click"
                          >
                            註冊
                          </button>
                        </div>
