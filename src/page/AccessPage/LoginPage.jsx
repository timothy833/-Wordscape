...
const LoginPage = ({ show, handleClose, handleShowSignupModal }) => {
  ...
  return (
    <>
      ...
      <div
        className={`access-modal-container ${show ? "show" : ""} w-100 h-100`}
      >
        <div className="access-modal-content h-100">
          <div className="login position-relative h-100">
            <div className="container-fluid h-100">
              <div className="row h-100 w-100 justify-content-center">
                {/* 左側區域 */}
                <div
                  className="d-none flex-column  d-lg-flex col-md-4 ps-5"
                    ...
                    <div className="card shadow-lg rounded-4 border-0 w-100 bg-white login-card mx-5">
                      <div className="card-body">
                        ...
                        >
                          <button
                            type="button"
                            className="btn-close login-btn-close"
                            onClick={() => {
                              handleClose();
                              setResetEmail({ email: "" });
                              setFormErrors({});
                            ...
                            aria-label="Close"
                          ></button>
                          <h5 className="card-title fs-6 fw-normal mb-5">
                            重新設定您的密碼
                          </h5>
                          <p className="fw-light mb-3">
                            {" "}
                            輸入註冊使用的 email，我們將寄送設定連結給您。
                          </p>
                          <div className="form-floating mb-5">
                            <input
                              type="email"
                              className={`form-control border-0 ${
                                validated && formErrors.email
                                  ? "is-invalid"
                                  : ""
                              }`}
                              id="resetEmail"
                          ...
                          <div className="d-grid">
                            <button
                              type="submit"
                              className="btn btn-primary py-3 mb-5 btn-click"
                            >
                              送出
                            </button>
                          </div>
                        ...
                        <div className="text-center my-5">
                          <a
                            onClick={returnLoginHandle}
                            href="#"
                            className="text-gray small btn-click"
                          >
                            返回
                          </a>
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        >
                          ...
                          <div className="d-grid">
                            <button
                              type="submit"
                              className="btn btn-primary py-3 mb-10 btn-click"
                            >
                              登入
                            </button>
                          </div>
                        ...
                        <div className="d-flex justify-content-center gap-5">
                          <a style={{ cursor: "pointer" }}>
                            <img
                              src="https://github.com/timothy833/-Wordscape/blob/main/src/assets/images/AccessPage/Facebook-icon.png?raw=true"
                              width="40px"
                              height="40px"
                              alt="facebook-login"
                            />
                          ...
                          <a style={{ cursor: "pointer" }}>
                            <img
                              src="https://github.com/timothy833/-Wordscape/blob/main/src/assets/images/AccessPage/apple-icon.png?raw=true"
                              width="40px"
                              height="40px"
                              alt="apple-login"
                            />
                          ...
                          <a style={{ cursor: "pointer" }}>
                            <img
                              src="https://github.com/timothy833/-Wordscape/blob/main/src/assets/images/AccessPage/google-icon.png?raw=true"
                              width="40px"
                              height="40px"
                              alt="google-login"
                            />
